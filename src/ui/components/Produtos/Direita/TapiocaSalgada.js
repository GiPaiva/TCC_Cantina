...
export default function TapiocaSalgada() {

    const [dados, setDados] = useState();
    const [carregado, setCarregado] = useState(false);
  
    async function pegaTodosProdutos() {
        let response = await fetch('https://api-cantina-production.up.railway.app/api/produtos/tapiocasalgada?key=1363dc7316d70ecf0803a4bd24ac15ab', {
            method: 'GET',
            headers: {
